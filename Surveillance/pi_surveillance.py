...
ap.add_argument("-f", "--face", required=False,
    help="path to the xml file that defines face")
...
if(args["conf"] != None):
    ...
    print("[INFO] Config filepath set to default value")

if(args["face"] != None):
    conf = (args["face"])
else:
    cascade_path= "haarcascade_frontalface_default.xml"
    print("[INFO] Face object filepath set to default value")

#make a cascade face classifier
...
for f in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    # find faces in frame
    faces = detect_face(gray, cascade)

    # find movement in frame based on previous
    contours = detect_motion(gray, avg)
